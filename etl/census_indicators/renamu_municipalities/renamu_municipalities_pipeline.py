...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        output_district['RENAMU_172'] = df.apply(lambda x: 1 if x['P78_3'] == 1 else 0 if x['P78_3'] == 0 else np.nan, axis=1)
...
class RENAMUPipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        load_step = LoadStep('inei_renamu_municipalities', db_connector, if_exists='drop', 
                             ...
                             pk=['district_id', 'year'], dtype=DTYPES,
                             nullable_list=[
