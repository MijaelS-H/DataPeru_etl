...
class EncuestaEmpresasPipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        dtypes = {
          ...
          'criterio_elegir_credito_prestamo_periodio_gracia':                                             'UInt8',
        ...
        join_step = JoinStep()
        load_step = LoadStep(
          'organization_survey', connector=db_connector, if_exists='drop',
          pk=['district_id', 'company_id', 'year'], dtype=dtypes, nullable_list=[
            ...
            'criterio_elegir_credito_prestamo_periodio_gracia',
