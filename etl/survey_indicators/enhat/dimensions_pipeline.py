...
from etl.survey_indicators.enhat.enhat_pipeline import TransformStep
...
class DimENHATPipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
...
def run_pipeline(params: dict):
    ...
    levels = {
        'category_id':  'dim_category_enhat',
        'indicator_id': 'dim_indicator_enhat'}
