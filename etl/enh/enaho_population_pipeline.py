...
class ENHPipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        dtype = {
            ...
            "has_DNI":                                                        "UInt8",
            "look_attention_MINSA_heath_post":                                       "UInt8",
            ...
            "where_did_you_buy_buy_glasses":                                     "UInt8",
        ...
        load_step = LoadStep(
            ...
            nullable_list=["gender_id", "age_years", "civil_status", "childhood_learned_lenguage", "actual_last_academic_degree", "has_college_career", "has_college_career_id",
                ...
                "use_internet_from_other", "use_internet_from_computer", "use_internet_from_laptop",
                "use_internet_from_own_cellphone", "use_internet_from_friends_cellphone", "use_internet_from_works_cellphone",
                "use_internet_from_tablet", "use_internet_from_other_device", "last_month_internet_highest_used", "how_much_cost_internet",
                ...
                "deflected_how_much_cost_particular_transportation", "deflected_how_much_cost_internet", "has_DNI", "look_attention_MINSA_heath_post",
                ...
                "where_did_you_buy_medicine", "where_did_you_buy_buy_glasses", "where_did_you_buy_contraceptives",
