...
class itp_indicators_m_n_nat_pipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        dtype = {
            "ubigeo":                                           "String",
            "month_id":                                         "UInt16",
            "ipc_base_2011_observado":                          "Float64",
            "ipc_base_2011_var_mes_anterior":                   "Float64",
            "ipc_base_2011_var_acumulado":                      "Float64",
            "ipc_base_2011_var_anio_anterior":                  "Float64",
            "ipm_base_2013_observado":                          "Float64",
            "ipm_base_2013_var_mes_anterior":                   "Float64",
            "ipm_base_2013_var_acumulado":                      "Float64",
            "perc_morosidad_credi_banca_mult":                  "Float64",
