...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        for year in [2018,2019,2020]:
            ...
            df_2[k].rename(columns={'anio': 'year','variable':'department_id','value':'total'}, inplace= True)
            df_2[k]['indicator_id'] = parameters[1] + '_' + df_2[k]['index']
            df_2[k]['nation_id'] = 'per'
            df_2[k]['response_name'] = 'Actividades de preservación'
        ...
        for year in [2018,2019,2020]:
            ...
            df_5[k]['indicator_id'] = parameters[8] + '_' +  df_5[k]['variable']
            df_5[k]['department_id'] = 0
            df_5[k]['nation_id'] = 'per'
            df_5[k].rename(columns={'NOMBRE': 'response_name','anio': 'year', 'value':'total'}, inplace=True)
        ...
        for year in [2018,2019,2020]:
            ...
            df_6[k]['indicator_id'] = parameters[9] + '_' +  df_6[k]['variable']
        ...
        for year in [2018,2019,2020]:
            ...
            df_7[k] = pd.melt(df_7[k], id_vars=['anio'], value_vars=['TOTAL_NINOS_NAC', 'TOTAL_NINOS_EXT', 'TOTAL_ESTUDIANTES_NAC',
               ...
               'TOTAL_MIL_BOLESP_NAC', 'TOTAL_MIL_BOLESP_EXT', 'TOTAL_ADM_BOLESP_NAC',
               'TOTAL_ADM_BOLESP_EXT'])
            df_7[k]['indicator_id'] = parameters[11] + '_' + df_7[k]['variable']
            df_7[k]['response_name'] = 'Visitantes a museos según tipo de público'
            df_7[k]['department_id'] = 0
            df_7[k]['nation_id'] = 'per'
            df_7[k].rename(columns={'anio': 'year', 'value':'total'}, inplace=True)
        ...
        for year in [2018,2019,2020]:
            ...
            df_8[k] = pd.melt(df_8[k], id_vars=['anio'], value_vars=['TOTAL_NINOS_NAC', 'TOTAL_NINOS_EXT', 'TOTAL_ESTUDIANTES_NAC',
               ...
               'TOTAL_MIL_BOLESP_NAC', 'TOTAL_MIL_BOLESP_EXT', 'TOTAL_ADM_BOLESP_NAC',
               'TOTAL_ADM_BOLESP_EXT'])
            df_8[k]['indicator_id'] = parameters[12]  + '_' + df_8[k]['variable']
            df_8[k]['department_id'] = 0
            df_8[k]['nation_id'] = 'per'
            df_8[k]['response_name'] = 'Visitantes a salas según tipo de público'
        ...
        df_9['total'] = 1
        df_9 = pd.melt(df_9, id_vars=['year','department_id','NOMBRE'], value_vars=['total'])
        df_9.rename(columns={'NOMBRE': 'response_name','value': 'total'}, inplace=True)

        df_9['indicator_id'] = parameters[15] 
        df_9['nation_id'] = 'per'

        df_9 = df_9[['year','indicator_id','department_id','nation_id','total','response_name']]

        k = 1
        df_10 = {}
        for year in [2018,2019,2020]:
            df_10[k] = query(parameters[16],year)  
            df_10[k]['indicator_id'] = parameters[16]
            df_10[k]['nation_id'] = 'per'
            df_10[k].rename(columns={'coddpto': 'department_id','anio': 'year', 'asist':'total'}, inplace=True)
            df_10[k]['response_name'] = 'Asistencia a las presentaciones de los elencos nacionales'
            df_10[k] = df_10[k][['year','indicator_id','department_id','nation_id','total','response_name']]
            k = k + 1
        ...
        for year in [2018,2019,2020]:
            ...
            df_11[k]['indicator_id'] = parameters[17] + '_' +  df_11[k]['variable']
            df_11[k]['department_id'] = 0
            df_11[k]['nation_id'] = 'per'
            df_11[k].rename(columns={'ELENCOS': 'response_name','anio': 'year', 'value':'total'}, inplace=True)
        ...
        for year in [2018, 2019, 2020]: 
            ...
            for i in range(0, len(df_query)):
                ...
                mini_df_query['year'] = df_query[df_query.columns[3]][i]
                df_12 = df_12.append(mini_df_query)

        df_12 = pd.melt(df_12, id_vars=['month','year','ELENCOS'], value_vars=['PRESENTACIONES','ASISTENTES'])
        df_12.rename(columns={'ELENCOS': 'response_name','value': 'total'}, inplace=True)
        df_12['department_id'] = 0
        df_12['nation_id'] = 'per'

        df_12['indicator_id'] = parameters[19] + '_' +  df_12['variable']

        df_12 = df_12[['year','indicator_id','department_id','nation_id','total','response_name']]

        k = 1
        df_13 = {}
        for year in [2016, 2017, 2018, 2019, 2020]:
            df_13[k] = query(parameters[21],year)
            df_13[k] = pd.melt(df_13[k], id_vars=['PUEBLO', 'anio'], value_vars=['HOMBRES', 'MUJERES', 'TOTAL'])
            df_13[k]['indicator_id'] = parameters[21] + '_' +  df_13[k]['variable']
            df_13[k]['department_id'] = 0
            df_13[k]['nation_id'] = 'per'
            df_13[k]['response_name'] = df_13[k]['PUEBLO']
            df_13[k].rename(columns={'anio':'year', 'value': 'total'}, inplace=True)
            df_13[k] = df_13[k][['year','indicator_id','department_id','nation_id','total','response_name']]
            k = k + 1
        ...
        df_14 = {}
        for year in [2016, 2017, 2018, 2019, 2020]:
            df_14[k] = query(parameters[22],year)
            df_14[k] = pd.melt(df_14[k], id_vars=['PUEBLO', 'anio'], value_vars=['LOCALIDADES'])
            df_14[k]['indicator_id'] = parameters[22] + '_' +  df_14[k]['variable']
            df_14[k]['department_id'] = 0
            df_14[k]['nation_id'] = 'per'
            df_14[k]['response_name'] = df_14[k]['PUEBLO']
            df_14[k].rename(columns={'anio':'year', 'value': 'total'}, inplace=True)
        ...
        df_15 = {}
        for year in [2016, 2017, 2018, 2019, 2020]:
            df_15[k] = query(parameters[23],year)
            df_15[k] = pd.melt(df_15[k], id_vars=['CODDEP', 'anio'], value_vars=['LOCALIDADES'])
            df_15[k]['indicator_id'] = parameters[23] + '_' +  df_15[k]['variable']
            df_15[k]['nation_id'] = 'per'
            df_15[k].rename(columns={'anio':'year', 'CODDEP' : 'department_id', 'value': 'total'}, inplace=True)
            df_15[k]['response_name'] = 'Localidades por departamento'
        ...
        for year in [2016, 2017, 2018, 2019, 2020]:
            ...
            for i in range(0, len(df_query)):
                ...
                df_16 = df_16.append(mini_df_query)
        df_16['indicator_id'] = parameters[24]
        df_16['nation_id'] = 'per'
        df_16['total'] = 1
        df_16.rename(columns={'TITULO' : 'response_name'}, inplace=True)
        df_16 = df_16[['year','indicator_id','department_id','nation_id','total','response_name']]

        df_list = [df_1, df_2, df_3, df_4, df_5, df_6, df_7, df_8, df_9, df_10, df_11, df_12, df_13, df_14, df_15, df_16]
